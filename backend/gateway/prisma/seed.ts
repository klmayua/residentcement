...
async function main() {
  ...
  const customers = await Promise.all([
    prisma.customer.upsert({
      where: { email: 'dangote.distributors@example.com' },
      update: {},
      create: {
        id: 'cust_001',
        name: 'Dangote Distributors Ltd',
        email: 'dangote.distributors@example.com',
        ...
        contactEmail: 'adebayo@dangotedist.com',
  ...
  const products = await Promise.all([
    ...
    prisma.product.upsert({
      where: { sku: 'DANG-CEM-25KG' },
      update: {},
      create: {
        id: 'prod_002',
        name: 'Dangote Cement 25kg',
        sku: 'DANG-CEM-25KG',
        description: 'Smaller pack for retail customers',
        category: 'CEMENT',
        status: 'ACTIVE',
        basePrice: 1800,
        costPrice: 1450,
    ...
    prisma.product.upsert({
      where: { sku: 'BUCEM-50KG' },
      update: {},
      create: {
        id: 'prod_003',
        name: 'BUA Cement 50kg',
        sku: 'BUCEM-50KG',
        description: 'Premium quality cement from BUA',
        category: 'CEMENT',
        status: 'ACTIVE',
        basePrice: 3400,
        costPrice: 2750,
    ...
    prisma.product.upsert({
      where: { sku: 'LAFARGE-50KG' },
      update: {},
      create: {
        id: 'prod_004',
        name: 'Lafarge Cement 50kg',
        sku: 'LAFARGE-50KG',
        description: 'Elephant brand cement - strength you can trust',
        category: 'CEMENT',
        status: 'ACTIVE',
        basePrice: 3600,
        costPrice: 2900,
      ...
      create: {
        ...
        items: {
          create: {
            id: 'oi_003',
            productId: 'prod_002',
            productName: 'Dangote Cement 25kg',
            sku: 'DANG-CEM-25KG',
            quantity: 60,
            unitPrice: 1800,
            total: 116100,
