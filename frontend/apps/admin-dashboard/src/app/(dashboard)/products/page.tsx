...
"Portland Cement": { color:"bg-blue-100 text-blue-800"},
"Bulk Cement": { color:"bg-purple-100 text-purple-800"},
"Packaging": { color:"bg-green-100 text-green-800"},
};
...
export default function ProductsPage() {
 ...
 <div>
 <h1 className="text-2xl font-bold text-cement-900">Products</h1>
 <p className="text-cement-500">Manage your product catalog</p>
 </div>
 <div className="flex space-x-2">
 <button className="inline-flex items-center rounded-lg border bg-white px-4 py-2 text-sm font-medium text-cement-700 hover:bg-cement-50">
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-cement-500">Total Products</p>
 <p className="text-2xl font-bold text-cement-900">{totalProducts}</p>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-cement-500">In Stock</p>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-cement-500">Out of Stock</p>
 ...
 className="h-10 w-full rounded-lg border border-cement-300 pl-10 pr-4 text-sm focus:border-primary focus:outline-none"
 />
 </div>
 <div className="flex space-x-2">
 <select
 ...
 className="rounded-lg border border-cement-300 px-3 py-2 text-sm focus:border-primary focus:outline-none"
 >
 ...
 <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-cement-500">Category</th>
 <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-cement-500">Price</th>
 <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-cement-500">Stock</th>
 <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-cement-500">Min Order</th>
 ...
 <tr key={product.id} className="hover:bg-cement-50">
 <td className="whitespace-nowrap px-6 py-4">
 <div>
 <div className="font-medium text-cement-900">{product.name}</div>
 <div className="text-xs text-cement-500">{product.description}</div>
 </div>
 </td>
 <td className="whitespace-nowrap px-6 py-4 text-sm text-cement-600">
 {product.sku}
 </td>
 <td className="whitespace-nowrap px-6 py-4">
 ...
 <span className="ml-1 text-xs text-cement-500">{product.unit}s</span>
 </div>
 </td>
 <td className="whitespace-nowrap px-6 py-4 text-sm text-cement-600">
 ...
 <td className="whitespace-nowrap px-6 py-4">
 <span className={`inline-flex rounded-full px-2.5 py-0.5 text-xs font-medium ${product.isActive ? 'bg-green-100 text-green-800 ' : 'bg-cement-100 text-cement-800 '}`}>
 {product.isActive ?"Active":"Inactive"}
 </span>
 </td>
 <td className="whitespace-nowrap px-6 py-4">
 <div className="flex space-x-1">
 <button className="rounded p-1 hover:bg-cement-100"title="Edit">
 <Edit className="h-4 w-4 text-cement-500"/>
 </button>
 <button className="rounded p-1 hover:bg-cement-100"title="Delete">
 ...
 <div className="flex space-x-2">
 <button className="rounded-lg border px-3 py-1 text-sm hover:bg-cement-50">Previous</button>
 <button className="rounded-lg border px-3 py-1 text-sm hover:bg-cement-50">Next</button>
 </div>
 </div>
 </div>
 </div>
