...
const priorityConfig: Record<string, { color: string; label: string }> = {
 LOW: { color:"bg-cement-100 text-cement-800", label:"Low"},
...
export default function OrdersPage() {
 ...
 <div>
 <h1 className="text-2xl font-bold text-cement-900">Orders</h1>
 <p className="text-cement-500">Manage customer orders</p>
 </div>
 ...
 statusFilter === status ?"border-primary ring-2 ring-primary":"bg-white"
 }`}
 >
 <div className="text-sm text-cement-500">{status}</div>
 <div className="text-2xl font-bold text-cement-900">{count}</div>
 </button>
 ))}
 </div>
 ...
 <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-cement-500">Items</th>
 <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-cement-500">Total</th>
 <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-cement-500">Priority</th>
 ...
 <div className="text-xs text-cement-500">{order.id}</div>
 </div>
 </td>
 <td className="whitespace-nowrap px-6 py-4">
 <div className="text-sm text-cement-900">{order.customerName}</div>
 </td>
 ...
 <>
 <button className="rounded p-1 hover:bg-cement-100"title="Update Status">
 <Truck className="h-4 w-4 text-cement-500"/>
 </button>
 <button className="rounded p-1 hover:bg-cement-100"title="Cancel Order">
