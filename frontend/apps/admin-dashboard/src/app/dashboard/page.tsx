...
import { Factory, Truck, ShoppingCart, Package, Banknote, CheckCircle, Store, Wrench, Users, Settings, Bell, HelpCircle, History, TrendingUp, BarChart3, Warehouse, ShoppingBag } from 'lucide-react';
...
const sidebarModules = [
  ...
  { href: '/dashboard/inventory', label: 'Warehouse', icon: Package },
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { label: 'Warehouse', icon: Warehouse, title: 'Clinker Reserves', value: '842,000 Tons', percent: '82%' },
