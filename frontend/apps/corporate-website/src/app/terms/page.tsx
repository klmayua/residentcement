    ...
    <main className="bg-stone-950 text-white">
      ...
      <section className="py-20 px-6 lg:px-10">
        <div className="max-w-[800px] mx-auto space-y-10">
          {[
            { title: "1. Acceptance of Terms", content: "By accessing and using the Resident Cement website and services, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by these terms, please do not use this service." },
            { title: "2. Services", content: "Resident Cement Bachi Ltd provides cement manufacturing, distribution, and related services. We reserve the right to modify, suspend, or discontinue any aspect of our services at any time without prior notice." },
            ...
            { title: "4. Intellectual Property", content: "All content, features, and functionality of our services, including but not limited to text, graphics, logos, and software, are the exclusive property of Resident Cement Bachi Ltd and are protected by copyright, trademark, and other intellectual property laws." },
            ...
            { title: "6. Limitation of Liability", content: "To the maximum extent permitted by law, Resident Cement Bachi Ltd shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of or relating to your use of our services." },
            { title: "7. Indemnification", content: "You agree to indemnify, defend, and hold harmless Resident Cement Bachi Ltd and its officers, directors, employees, and agents from any claims, liabilities, damages, losses, or expenses arising out of your use of our services or violation of these Terms." },
